document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (event) => {
        ...
        if (isEditing && currentEditedElement) {
            /* 
            --- ЗАВДАННЯ  ---    
            Оновіть DOM-елементи всередині currentEditedElement даними з taskData
            для заголовку, опису, тегу та дедлайну
            Використовуйте querySelector і BEM класи (.task-card__title і т.д.)
            */
